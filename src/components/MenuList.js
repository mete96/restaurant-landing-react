  ...
  const desertMenu = () => {
    ...
    setMenu(
      <>
        <div className="menu1">
          <div className="img-menu">
            <img src={icecream} className="menu" />
          </div>
          <h2>Ice Cream</h2>
          <p>
            Double quarter pound pure fresh house-made cheeseburger, topped with
        ...
        <div className="menu1">
          <div className="img-menu">
            <img src={baklava} className="menu" />
          </div>
          <h2>BAKLAVA</h2>
          <p>
            Double quarter pound pure fresh house-made cheeseburger, topped with
  ...
  const burgerMenu = () => {
    ...
    setMenu(
      <>
        ...
        <div className="menu1">
          <div className="img-menu">
            <img src={burger2} className="menu" />
          </div>
          <h2>JUST BURGER</h2>
          <p>
            Double quarter pound pure fresh house-made cheeseburger, topped with
        ...
        <div className="menu1">
          <div className="img-menu">
            <img src={burger1} className="menu" />
          </div>
          <h2>BIG MAC</h2>
          <p>
            Double quarter pound pure fresh house-made cheeseburger, topped with
        ...
        <div className="menu1">
          <div className="img-menu">
            <img src={burger3} className="menu" />
          </div>
          <h2>GOOD BURGER</h2>
          <p>
            Double quarter pound pure fresh house-made cheeseburger, topped with
  ...
  useEffect(() => {
    setMenu(
      <>
        ...
        <div className="menu1">
          <div className="img-menu">
            <img src={burger4} className="menu" />
          </div>
          <h2>MAC N CHEESE</h2>
          <p>
            Double quarter pound pure fresh house-made cheeseburger, topped with
